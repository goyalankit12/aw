...
<ol align="left" >
    <li> <b>Chart 1:</b>This help us comparing any two of the above  mentioned five activities. If the user has more count of posting questions as compares to posting answers than that means user primarly visits the site for seeking help else if the count of answer is high than that means he visitis site to answer the questions. This  means that he has good knowledge of the subject area where he answers the questiosn. This help us encourage student who has good count of posting answer tha count of posting questions, to answer more relevent questions by showint notification. similarly, we can draw many more conclusions based on the relative comparision between the activities. </li>
    <br/>
    <li> <b>Chart 2:</b>This help us finding the count of activities by that particular user vs average count of all the activities made by all the users. This helps us finding how much user is active as compared to other users on the sarckoverflow. We can also find the pattern of activities for which activity in  particular  user  is more active than the average users on the site. We can encourage user to do more activities in which he has less than than average count. </li>
    <br/>
    <li> <b>chart 3:</b>User can click any of the button to find the pattern of that particular activity for past 30 days. This help us fiding the pattern of user behaviour for that particular activities for past 30 days. For example, if user hasn't posted any question in past 30 days than we should do more anaylsis on the reason behind not posting any questions. </li>
    <br/>
